...
namespace C25519
{
    class Program
    {
        public static void Main(string[] args)
        {
            ...
            watch.Stop();
            Console.WriteLine(" Time for EcDSA signing {0} ms", watch.ElapsedMilliseconds);
            ...
            watch.Stop();
            Console.WriteLine(" Time for EcDSA verification {0} ms", watch.ElapsedMilliseconds);
            ...
            watch.Stop();
            Console.WriteLine(" Time for EdDSA signing {0} ms", watch.ElapsedMilliseconds);
            ...
            watch.Stop();
            Console.WriteLine(" Time EdDSA verification {0} ms", watch.ElapsedMilliseconds);
            ...
            watch.Stop();
            Console.WriteLine(" Time Encryption and Decryption {0} ms", watch.ElapsedMilliseconds);
            ...
            watch.Stop();
            Console.WriteLine(" Time Key Exchange {0} ms", watch.ElapsedMilliseconds);
        }
